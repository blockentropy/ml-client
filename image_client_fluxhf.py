...
# was not released.
bfl_repo = "/home/ed/Documents/huggingface/FLUX.1-schnell"
revision = "refs/pr/1"
adapter_id = '/home/ed/Documents/huggingface/fluxlora'
...
pipe = FluxPipeline.from_pretrained(bfl_repo, torch_dtype=torch.bfloat16, transformer=transformer, text_encoder_2=None)
#pipe = FluxPipeline(
#    scheduler=scheduler,
